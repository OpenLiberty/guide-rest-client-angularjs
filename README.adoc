...
following URL: http://localhost:9080[window="_blank"].
...
After you start the server, you can find your artist JSON at the following URL: http://localhost:9080/artists[window="_blank"].
...
After everything is set up, point your browser to the application root http://localhost:9080[window="_blank"] to
...
Whenever you change your AngularJS implementation, the application root at http://localhost:9080[window="_blank"] will
