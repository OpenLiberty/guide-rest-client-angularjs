...
[role="code_command hotspot=2", subs="quotes"]
----
The `ngResource` module is registered as it is appended after `consumeRestApp`. 
----
...
[role="code_command hotspot=6-8", subs="quotes"]
----
Next, the `Artist` AngularJS service is defined by using the Factory recipe. 
----
...
[role="code_command hotspot=12-18", subs="quotes"]
----
The controller controls the flow of data in your application.
----
...
[role="code_command hotspot=17-46", subs="quotes"]
----
Replace the contents of `start/src/main/webapp/index.html` with the following:
----

index.html
[source, html, indent=0, linenums, role="code_column"]
----
include::finish/src/main/webapp/index.html[tags=**]
----

[role="code_command hotspot=20-24", subs="quotes"]
----
...
[role="code_command hotspot=29-42", subs="quotes"]
----
The application is bootstrapped because the `consumeRestApp` application module is attached to the `body` of the template.
----

[role="code_command hotspot=29", subs="quotes"]
----
Next, the `ArtistCtrl` controller is attached to the DOM to create a new child scope. 
----
...
[role="code_command hotspot=27-44", subs="quotes"]
----
You can use the `ng-repeat` directive to iterate over the contents
