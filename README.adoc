...
The first import is the base AngularJS library, defining the [hotspot=angular-script file=0]`angular.js` script in your HTML. The second import is the library responsible for providing the APIs for the `$resource` service, defining the 
