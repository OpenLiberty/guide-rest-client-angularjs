...
following URL: `\http://localhost:9080/index.html`.
...
After everything is set up, point your browser to the application root http://localhost:9080/index.html[http://localhost:9080/index.html^] to
...
Whenever you change your AngularJS implementation, the application root at http://localhost:9080/index.html[http://localhost:9080/index.html^] will
