...
Begin by defining the application module. Create `consume-rest.js` under the `start/src/main/webapp/js`
directory. To use the `$resource` service, also include the `ngResource` module in your definition:
