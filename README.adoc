...
:page-seo-title: Consuming a RESTful web service with AngularJS
:page-seo-description: A tutorial on how to access a REST service and deserialize the returned JSON  by using the high-level `$resource` service of AngularJS.
