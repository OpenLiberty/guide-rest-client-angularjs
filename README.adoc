...
Whenever you change your AngularJS implementation, the application root at the `localhost:9080` URL reflects the changes automatically. Visit the root to manually check whether the artist JSON file was consumed correctly.
